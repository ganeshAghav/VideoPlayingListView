...
public class VideoPlayerController {
    ...
    MediaStore.Video currentPlayingVideo;
    ...
    public void loadVideo(MediaStore.Video video, VideoPlayer videoPlayer, ProgressBar progressBar) {
...
//Second if the videoplayer of this video is currently showing in the list or visible
    ...
    public void handlePlayBack(MediaStore.Video video)
    {
            ...
            if(videos.containsKey(video.getIndexPosition()))
            {
                ...
                if(!videoPlayer2.isLoaded)
                {
                    ...
                    videoPlayer2.setOnVideoPreparedListener(new IVideoPreparedListener() {
                        @Override
                        public void onVideoPrepared(MediaStore.Video mVideo) {
    ...
    private boolean isVideoVisible(MediaStore.Video video) {
    ...
    private boolean isVideoDownloaded(MediaStore.Video video) {
    ...
    private void showProgressSpinner(MediaStore.Video video) {
        ProgressBar progressBar = videosSpinner.get(video.getIndexPosition());
        if(progressBar!=null)
            progressBar.setVisibility(View.VISIBLE);
    }

    private void hideProgressSpinner(MediaStore.Video video) {
